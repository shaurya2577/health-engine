...
function Home() {
  ...
  return (
    ...
    {/* <div>
      <div className="text-2xl p-20 mr-5 flex-wrap flex-row" style={{ display: "flex", flexDirection: "row" }}>
        {resources.map(resource_entry => (
          <div key={resource_entry.resource_id} class="w-200 h-100 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
          <a href="#">
          ...
          <div className="p-6">
              ...
              <p class="mb-3 font-normal text-gray-700 dark:text-gray-400 whitespace-normal break-words"> {resource_entry.description} </p>
